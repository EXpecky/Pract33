...
namespace UnitTest1
{
	...
	public:
		...
		TEST_METHOD(validMoneyData)
		{
			...
			auto& date = vec.at(0).get_Date();

			Assert::IsTrue(date.getDay() == 10);
			Assert::IsTrue(date.getMonth() == 9);
			Assert::IsTrue(date.getYear() == 2020);

			Assert::IsTrue(vec.at(0).get_name1() == "RUB");
			Assert::IsTrue(vec.at(0).get_name2() == "UAH");
			Assert::IsTrue(vec.at(0).get_kurs() == 12);

			date = vec.at(1).get_Date();
			...
			Assert::IsTrue(vec.at(1).get_name1() == "TRY");
			Assert::IsTrue(vec.at(1).get_name2() == "EUR");
			Assert::IsTrue(vec.at(1).get_kurs() == 13);
